...
float pressure2 = baro.getPressure();
  int altitude2 = baro.getAltitude();
  int temperature2 = baro.getTemperature();
  ...
  sendStringToBase("P" + String(pressure) + "\n");
  sendStringToBase("T" + String(temperature) + "\n");
  sendStringToBase("A" + String(altitude) + "\n");
  sendStringToBase("G" + String(gpsData) + "\n");
  Serial.println(altitude);
  releaseCanSat();
   delay(250);
